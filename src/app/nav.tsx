        ...
        <div className='px-8 py-2 m-auto'>
            <div className='flex justify-between items-center max-w-7xl m-auto border border-gray-200 p-2 rounded-xl shadow-sm'>
                ...
                <div className='flex items-center max-sm:hidden'>
                    ...
                    <Link href="/login">
                        <button type="button" className="text-white cursor-pointer bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-bold rounded-lg text-md px-5 py-2.5 text-center">
                            Entrar
                        </button>
                    </Link>
                </div>
